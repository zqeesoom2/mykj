...
document.write('<script src="' + bootPATH + 'jquery-1.7.2.min.js" type="text/javascript" ></sc' + 'ript>');
...
var skin = 'bootstrap';
if (skin) {
    document.write('<link href="' + bootPATH + 'miniui/themes/' + skin + '/skin.bak.css" rel="stylesheet" type="text/css" />');
}
