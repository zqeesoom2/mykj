...
KindEditor.plugin('baidumap', function(K) {
	...
	self.clickToolbar(name, function() {
		...
		var div = dialog.div,
			...
			win, doc;
		var iframe = K('<iframe class="ke-textarea" frameborder="0" src="' + self.pluginsPath + 'baidumap/map.bak.html" style="width:' + mapWidth + 'px;height:' + mapHeight + 'px;"></iframe>');
		function ready() {
			...
			for (var i = 0; i < rows; i++) {
				...
				for (var j = 0; j < cols; j++) {
					...
					var span = K('<span class="ke-img"></span>')
						...
						.css('background-image', 'url(' + path + 'Mykj.gif)');
					cell.append(span);
					elements.push(cell);
					num++;
				}
...
KindEditor.plugin('map', function(K) {
	...
	self.clickToolbar(name, function() {
		...
		var iframe = K('<iframe class="ke-textarea" frameborder="0" src="' + self.pluginsPath + 'map/map.bak.html" style="width:558px;height:360px;"></iframe>');
		function ready() {
			win = iframe[0].contentWindow;
			doc = K.iframeDoc(iframe);
			//doc.open();
