                        ...
                        wx.translateVoice({
                            ...
                            complete: function (res) {
                                if (res.hasOwnProperty('translateResult')) {
                                    $('#Questing').val(res.translateResult);
                                } else {
                                    alert('无法识别');
                                }
                            }
...
//提交追问信息
    function submit () {
        var Questing =  $('#Questing').val();

        if(Questing.length<2){
        ...
        var data ={'quiz':Questing,'aid':$("#lastAnswerId").val(),'toUserid':$("#toUserid").val()};
    ...
    $('#submitQuesting').on('click',function(){
        submit();
    });
